...
<div>
    <nav id="nav" class="nav-2">
        ...
        <ul class="nav-options">
            <li class="nav-option button" @click="exit"><i class="bi bi-house-fill"></i>&nbsp;{{$t('nav.home')}}</li>
            <li class="nav-option button" @click.prevent="save"><i class="bi bi-cloud-download-fill"></i>&nbsp;{{$t('nav.save')}}</li>
            <li class="nav-option button" @click="settings"><i class="bi bi-gear-fill"></i>&nbsp;{{$t('nav.setting')}}</li>
            <li>
                <button>
